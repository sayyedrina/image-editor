...
left_frame = ttk.Frame(root, width=1000, height=1000)
...
image_icon = ttk.PhotoImage(file = 'add.png').subsample(4, 4)
flip_icon = ttk.PhotoImage(file = 'flip.png').subsample(4, 4)
rotate_icon = ttk.PhotoImage(file = 'rotate.png').subsample(4, 4)
color_icon = ttk.PhotoImage(file = 'color.png').subsample(4, 4)
erase_icon = ttk.PhotoImage(file = 'erase.png').subsample(4, 4)
save_icon = ttk.PhotoImage(file = 'saved.png').subsample(4, 4)
